...
class Desktop extends Component {
	...
	render() {
		return (
			<div className="col-xl-11 col-lg-10 col-md-9 col-sm-9 col-7 main-section d-flex flex-column justify-content-center align-items-center" onDragLeave={this.leaveHandler} onDragOver={this.dragOverHandler}>
